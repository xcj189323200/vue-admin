<template>
  <div id="tableList">
    ...
    <div class="page_box">
      <el-pagination background layout="prev, pager, next" @current-change='pageChange_handler' :page-size.sync='size' :total="total"></el-pagination>
    </div>
  </div>
</template>
...
<script>
  ...
  */
export default {
  props:['loading','dataList','size','total'],
  components: {
  },
  data() {
        return {
